 ...
 * because they are absent from the deployed site altogether - the
 * self-test is developer tooling and the deploy job strips it. Nothing
 * to cache, and the 1.5 MB fixture never reaches an installed copy.
 */
